...
from tuw_nlp.sem.hrg.steps.bolinas.common.exceptions import LexerError, ParserError
...
class GraphDescriptionParser(object):
    ...
    def parse_string(self, s, concepts=True):
        ...
        new_rev_ext_nodes = {}
        i = 0
        for node, index in sorted(hgraph.external_nodes.items(), key=lambda k, v: v):
